...
fileName <- "/home/davidechicco/my_projects/hepatocellular_carcinoma/data/hcc-data_EDITED_NAs_cosineDist_data_imputed_1464636.csv"
targetName <- "survivalTarget"
...
{
    cat("exe_i=", exe_i, " out of ", execution_number, "\n", sep="")
